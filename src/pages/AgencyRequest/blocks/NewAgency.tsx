...
export const NewAgency: React.FC<TNewAgency> = ({ isOpen, onOpenChange }) => {
  const {} = useForm();
    ...
    >
      <ModalContent>
        <>
          ...
          <ModalBody>
            <FormInput className="w-96" placeholder="Şirkətin adı" />
            <FormInput className="w-96" placeholder="E-mail" />
            <FormInput
              className="w-96"
