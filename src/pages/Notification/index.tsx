...
import { NewNotification } from "./blocks/NewNotification";
...
export const Notification = () => {
  ...
  return (
    <>
      <NewNotification isOpen={isOpen} onOpenChange={onOpenChange} />
      <Wrapper title="Bildiriş">
        <>
                    ...
                    <TableCell className="text-center">
                      <div className="relative flex justify-end items-center gap-2">
                        <Dropdown>
                          ...
                          <DropdownMenu>
                            <DropdownItem
                              className="admin-dropdown w-full flex items-center justify-start"
                              onClick={onOpen}
                            >
